 ...
 *             an existing record (key field locked), and a method
 *             to update an existing state record.
 ...
 * form pre-filled with an existing record's values, and updating
 * an existing state record.
 *
